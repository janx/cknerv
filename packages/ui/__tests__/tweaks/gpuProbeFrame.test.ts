...
const DRAW_LABELS = [
  ...
  PERFORMANCE_PROBE_LABELS.colonyCohortLens,
  PERFORMANCE_PROBE_LABELS.colonyCohortMotes,
  PERFORMANCE_PROBE_LABELS.colonyCourierPlume,
  PERFORMANCE_PROBE_LABELS.colonyCourierBloom,
  PERFORMANCE_PROBE_LABELS.deliveryMote,
  PERFORMANCE_PROBE_LABELS.deliveryPlume,
