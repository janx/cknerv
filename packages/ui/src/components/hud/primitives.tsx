...
export function PanelHeader({ en, cjk, idx }: { en: string; cjk: string; idx: string }) {
  return (
    <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 11 }}>
      ...
      <span style={{ marginLeft: 'auto', fontFamily: HUD_FONTS.mono, fontSize: 8.5, color: '#5a6470', letterSpacing: 1 }}>{idx}</span>
    </div>
  );
}
