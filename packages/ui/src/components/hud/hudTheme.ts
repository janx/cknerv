...
export function injectHudTheme(doc: Document = document): void {
  ...
  style.textContent =
    ...
    + `\n@media (max-width:1100px){.cknerv-cell-display-label,.cknerv-quality-label,.cknerv-top-bar-action-label{display:none}}`
    + `\n@media (max-width:380px){.cknerv-panel-toggle-label{display:none}}`
