...
const EXPECTED_DEFAULTS = {
  ...
  // The thirteen `cohort*` knobs are the POW channel — ONE LENSED MASS PER
  ...
  peer: { ambientAmp: 0.22, ambientSpeed: 0.05, ambientSigma: 0.17, surgeAmp: 1.1, surgeSigma: 0.13, surgeEase: 0.12, colorBoost: 3.75, alphaBoost: 2.75, sizeBoost: 0.5, trailBoost: 0.18, colorCeil: 1.4, alphaCeil: 1.1, flameWidth: 0.7, flameMinLen: 0.7, flameMaxLen: 2.5, flameBloom: 0.7, glintBloomOpacity: 0.55, glintPlumeOpacity: 0.3, cohortHorizon: 0.77, cohortDiscOut: 28, cohortDiscAmp: 1.5, cohortBeam: 0.45, cohortFarAmp: 0.9, cohortGlow: 0.35, cohortWarmth: 0, cohortUnfold: 50, cohortSteps: 96, cohortIntake: 12, cohortSwirl: 1.4, cohortOrbit: 1.2, cohortMotes: 1 },
