...
//   • BlockDeliveryLayer — one galaxy-facing octagonal jellyfish per measured
//     worker (timed by cf.arrivals) plus the local source. Its field-bell and
//     tendrils resolve into an expanding impact wave + real Cell illumination.
//
