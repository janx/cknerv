...
const EXPECTED_DEFAULTS = {
  ...
  cell: { fabricAlpha: 0.12, activeColorR: 1.0, activeColorG: 0.55, activeColorB: 0.15, fabricWidth: 2.5, activeWidth: 3.4, reinforceAmount: 0.34, reinforceGain: 1.6, reinforceHalfLife: 3.0 },
} as const;
