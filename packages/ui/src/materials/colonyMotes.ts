 ...
 * the mark is the intake over a five-unit catchment — a peer-sized heart with
 * the medium's arms winding into it (2026-09-03) — and a catchment wider than
 * the arms would weight a swing outside anything that is drawn.
 */
